...
class PipelineRegister:
    def __init__(self):
        ...
        self.alu_ctrl = 0
        self.ALUOp = 0
# TODO: Add in all the needed registers
# TODO: Place in stalls for hazards (add in hazards)
# TODO: Check how the cycles are done (pipeline cycles not single cycle)
